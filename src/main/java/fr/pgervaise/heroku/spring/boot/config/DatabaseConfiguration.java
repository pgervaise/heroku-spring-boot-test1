package fr.pgervaise.heroku.spring.boot.config;
 ...
 */
// @Configuration
// @EnableJpaRepositories("fr.pgervaise.heroku.spring.boot.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    public DataSource getDataSource() throws URISyntaxException {
        ...
        if (dbProperty != null) {
            logger.info("Init DB from DATABASE_URL property");
            ...
            logger.info("Init DB from default");
